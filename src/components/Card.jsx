  ...
  return (
    <div
      className={
        ...
        className
      } // Added className prop so they will stack on top of each other
      style={{
    ...
    >
      ...
      <div className="flex items-center justify-between z-10">
        <div>
          <h2 className="text-2xl font-bold mb-0.5">{name}</h2>
      ...
      <img
        src={image}
        alt={name}
        className="w-64 h-64 object-contain mt-5 drop-shadow-[0_2px_2px_rgba(0,0,0,0.2)] mx-5 mb-7"
      />
    </div>
  );
};
